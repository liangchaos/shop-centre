...
public class DefaultServiceApplication {
    private static Logger logger = LoggerFactory.getLogger (DefaultServiceApplication.class);
    ...
    public static void main (String[] args) {
        ...
        SpringApplicationBuilder springApp = new SpringApplicationBuilder (DefaultServiceApplication.class);
        ...
        DefaultServiceApplication bean = springApp.context ().getBean (DefaultServiceApplication.class);
        ...
        bannerPrinter.printBanner (springApp.context ().getEnvironment (), DefaultServiceApplication.class, System.out);
